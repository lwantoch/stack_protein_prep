"""Internal helpers for parameter_audit.py.

All private/helper functions, constants, dataclasses, and non-entry-point
public helpers are kept here so parameter_audit.py can be a thin
orchestrator.
"""
