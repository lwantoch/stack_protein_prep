"""Internal helpers and data for nonstd_residue_params.py.

All private/helper functions, constants, and data are kept here so
nonstd_residue_params.py can be a thin orchestrator exposing only the public API.
"""
